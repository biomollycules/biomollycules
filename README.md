...
## [![Typing SVG](https://readme-typing-svg.demolab.com?font=times+new+roman&pause=1000&color=cde9e9&width=435&lines=first+things+first...)](https://git.io/typing-svg)

![C](https://img.shields.io/badge/C-Novice-cde9e9) ![Python](https://img.shields.io/badge/Python-Novice-cde9e9?logo=Python&logoColor=ffb6d3) ![GitHub](https://img.shields.io/badge/GitHub-Intermediate-cde9e9?logo=GitHub&logoColor=ffb6d3) ![HTML](https://img.shields.io/badge/HTML-Intermediate-cde9e9) ![CSS](https://img.shields.io/badge/CSS-Intermediate-cde9e9?logo=CSS&logoColor=ffb6d3) ![Linux](https://img.shields.io/badge/Linux-Novice-cde9e9?logo=Linux&logoColor=ffb6d3) ![Java](https://img.shields.io/badge/Java-Novice-cde9e9)


| ![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=bambistacks&langs_count=8&bg_color=000000&title_color=ffffff&text_color=ffb6d3) | <p align="left">Hi! I'm Molly aka 𝖇 𝖆 𝖒 𝖇 𝖎 *s t a c k s* ☆<br> I'm a *software engineering* student @ University of Minnesota<br> I am focused on biotechnology & medical devices<br> especially embedded systems in medical devices + wearable tech <br> passionate about health, nutrition, + overall wellness<br> integrating these passions into my career brings me *fulfillment + balance* ॐ <br> </p> |
|-------------------------|-------------------------|
*GOALS* <br><br> ★ participate in medical research <br> ★ complete biotech field internship <br> ★ create a fitness app <br>★ goal 4 💭 | *FUN FACTS* (✿◠‿◠) <br><br> ★ I have a blind 10 year old chihuahua named *Jasmine/Jazz* <br> ★ I normally workout 5 days/week <br> ★ started meditation + yoga to heal PTSD, now it's a lifestyle <br> ★ spend most of my time in the sun on a paddleboard, SUPyoga! <br>
...
## [![Typing SVG](https://readme-typing-svg.demolab.com?font=times+new+roman&pause=1000&color=cde9e9&width=435&lines=lets+connect+on+socials...)](https://git.io/typing-svg) 
